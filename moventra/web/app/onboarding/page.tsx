...
// 🔹 Buradaki tüm subHobbies string’leri prisma/seed-hobbies.cjs içindeki
// hobbies array’i ile bire bir aynı yazılmalı.
const INTEREST_CATEGORIES: InterestCategory[] = [
  {
    id: "social",
    label: "Social & casual meetups",
    subHobbies: [
      "Coffee Meetup",
      "Brunch Meetup",
  ...
  {
    id: "local_business",
    label: "Local shops & small businesses",
    subHobbies: [
